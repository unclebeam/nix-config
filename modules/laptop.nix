...

{
  ...
  # ── Lid & suspend ──────────────────────────────────────────────────────
  # logind handles the lid; swayidle (home/sway.nix) locks the session
  ...
  # ── Backlight ──────────────────────────────────────────────────────────
  # brightnessctl (installed in home/sway.nix, bound to the XF86 brightness
  # keys) talks to logind — no extra permissions or udev rules needed for
