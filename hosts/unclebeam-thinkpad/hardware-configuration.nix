...
# │      hosts/unclebeam-thinkpad/hardware-configuration.nix                │
# │   git add hosts/unclebeam-thinkpad/hardware-configuration.nix           │
# │                                                                         │
...

{
  ...
  warnings = [
    "hosts/unclebeam-thinkpad/hardware-configuration.nix is a PLACEHOLDER. Run nixos-generate-config on the machine and replace it before installing."
  ];
}
